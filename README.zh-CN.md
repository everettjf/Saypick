...
检测与翻译覆盖使用人数最多的 10 种语言：**英语、中文、印地语、西班牙语、法语、阿拉伯语、孟加拉语、俄语、葡萄牙语、印尼语**。在**设置 → Language** 里选好你的母语和外语。读/写快捷键（macOS 为 `⌥D / ⌥R`，Windows 为 `Alt+D / Alt+R`）各有独立方向：**自动**检测选中文字的语言并翻译成另一种，混合语言容易误判时也可以钉死**固定**方向。
